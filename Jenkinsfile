...
//        e.g https://github.com/GreenSmile/events-app-web-server might become https://github.com/MyName/external.git
// variables:
...
//      https://github.com/GreenSmile/events-app-web-server
//      greensmile
//      web-server-image
//      events-cluster 
...
pipeline {
    ...
    environment {
        ...
        imageName = 'greensmile/web-server-image'
        dockerImage = ''
    }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/GreenSmile/events-app-web-server'
